...
@Component({
  ...
  template: `
    <ul class="nav nav-tabs">
      <li *ngFor="let tab of tabs" (click)="selectTab(tab)" [class.active]="true">
        <a href="#">{{tab.title}} <span class="tab-close" (click)="closeTab(tab)">x</span></a>
      </li>
      <!-- dynamic tabs 
      <li *ngFor="let tab of dynamicTabs" [class.active]="tab.active">
...
export class TabsComponent implements AfterContentInit {
  ...
  */
  ...
  openTab(title: string, template, data, isCloseable = false) {
    ...
    console.log(instance.dataContext);
